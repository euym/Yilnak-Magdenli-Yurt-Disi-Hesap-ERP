  ...
  return <div className="layout">
    ...
    <main className="card"><h2>{editingExpenseId ? 'Masraf Düzeltme' : 'Masraf Girişi'}</h2>
      <form onSubmit={saveExpense}>
        ...
        <div className="formActions"><button className="primary" type="submit">{editingExpenseId ? 'Masrafı Güncelle' : 'Masraf Ekle'}</button>{editingExpenseId && <button type="button" className="ghost" onClick={cancelExpenseEdit}>Vazgeç / Yeni Masraf</button>}</div>
      </form>
